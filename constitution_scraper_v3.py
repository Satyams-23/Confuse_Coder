...
print("Starting Constitution scraper with redirect handling...")

# Step 1: Try multiple URLs for Constitution of India
urls_to_try = [
    "https://www.indiacode.nic.in/handle/123456789/15240?lang=en&locale=en",
    "https://www.constitutionofindia.net/",
    "https://www.mea.gov.in/Images/pdf1/Part1.pdf"  # This might be a PDF, but let's try
]
...
for url_index, url in enumerate(urls_to_try):
    ...
    try:
        ...
        # Step 2: Send GET request with redirect following
        ...
        if res.status_code == 200:
            ...
            for i, para_text in enumerate(article_paragraphs[:20]):
            ...
            if data:
                print(f"\nSuccessfully scraped data from URL {url_index + 1}!")
                break
