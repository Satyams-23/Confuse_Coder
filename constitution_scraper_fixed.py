...
print("Starting Constitution scraper with correct URL...")

# Step 1: Use the correct URL for Constitution of India
url = "https://legislative.gov.in/document/constitution-of-india-in-english"
